        ...
        <div className={styles.setting}>
          ...
          <div className='row'>
            ...
            <div className='col col-6 col-lg-3'>
              ...
              <p className={cn('txt-m', styles.conversionText)}>Возможно, на работу в нише &lsquo;бурение на воду&rsquo; влияют особенности региона, о которых мы раньше не знали. Клиент подтвердил наше предположение: на юге области бурить скважины проще, конкуренты используют там недорогое оборудование, вплоть до ручных буров, поэтому предлагают цены ниже. Геосервис же использует только дорогостоящие установки на базе тяжелых грузовиков &lsquo;Урал&rsquo;. На севере области из-за особенностей почвы бурить можно только дорогостоящим оборудованием. Для этих районов Геосервис предлагает отличные условия. Как следствие, на севере процент выезда и процент продаж гораздо выше, чем на юге.</p>
            </div>
            <div className='col col-6 col-lg-1'></div>
            <div className='col col-6'>
