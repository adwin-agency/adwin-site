import styles from './ProjectInstepAbout.module.scss'

export default function ProjectInstepAbout() {
  return (
    <section className={styles.el}>
      <div className="container">
        <img className={styles.logo} src="/images/projects/instep/about-logo.svg" alt="" />
        <div className={styles.top}>
          <h2 className={styles.heading}>Лендинг, как первый шаг к организации продаж</h2>
