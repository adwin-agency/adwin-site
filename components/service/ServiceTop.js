        ...
        <div className={styles.main}>
          ...
          {type === 'corporate' && (
            <svg viewBox="0 0 1188 541" fill="none" xmlns="http://www.w3.org/2000/svg" className={styles.image}>
              <path d="M660 1H763V5C763 7.76142 760.761 10 758 10H665C662.239 10 660 7.76142 660 5V1Z" stroke="#1B1A1A" stroke-width="2" />
              ...
              <path d="M174 1H277V5C277 7.76142 274.761 10 272 10H179C176.239 10 174 7.76142 174 5V1Z" stroke="#1B1A1A" stroke-width="2" />
              ...
              <path d="M1 20C1 9.50658 9.50659 1 20 1H443C453.493 1 462 9.50659 462 20V241C462 251.493 453.493 260 443 260H20C9.5066 260 1 251.493 1 241V20Z" stroke="#1B1A1A" stroke-width="2" />
              <path d="M487 20C487 9.50658 495.507 1 506 1H929C939.493 1 948 9.50659 948 20V241C948 251.493 939.493 260 929 260H506C495.507 260 487 251.493 487 241V20Z" stroke="#1B1A1A" stroke-width="2" />
          ...
          {type === 'store' && (
            <svg viewBox="0 0 672 565" fill="none" xmlns="http://www.w3.org/2000/svg" className={styles.image}>
              ...
              <path d="M290 1H427V8C427 10.7614 424.761 13 422 13H295C292.239 13 290 10.7614 290 8V1Z" stroke="#DBDBDB" stroke-width="2" />
              ...
              <path d="M260 28H397V35C397 37.7614 394.761 40 392 40H265C262.239 40 260 37.7614 260 35V28Z" stroke="#DBDBDB" stroke-width="2" />
              ...
              <path d="M230 61H367V68C367 70.7614 364.761 73 362 73H235C232.239 73 230 70.7614 230 68V61Z" stroke="#1B1A1A" stroke-width="2" />
              ...
              <rect x="506.726" y="91.4142" width="14.7251" height="14.7251" rx="7.36254" transform="rotate(45 506.726 91.4142)" stroke="#1B1A1A" stroke-width="2" />
          ...
          {type === 'context' && (
            <svg viewBox="0 0 635 398" fill="none" xmlns="http://www.w3.org/2000/svg" className={styles.image}>
              <path d="M46 1H589C599.493 1 608 9.50659 608 20V363H27V20C27 9.50659 35.5066 1 46 1Z" stroke="#1B1A1A" stroke-width="2" />
              <rect x="47" y="296" width="423" height="66" fill="#DBDBDB" />
              <path d="M20 397H615C625.493 397 634 388.493 634 378V363H1V378C1 388.493 9.50659 397 20 397Z" stroke="#1B1A1A" stroke-width="2" />
              <path d="M245 1H375V8C375 10.7614 372.761 13 370 13H250C247.239 13 245 10.7614 245 8V1Z" stroke="#1B1A1A" stroke-width="2" />
          ...
          {type === 'target' && (
            <svg viewBox="0 0 541 540" fill="none" xmlns="http://www.w3.org/2000/svg" className={styles.image}>
              ...
              <path d="M251 89H291V96C291 98.7614 288.761 101 286 101H256C253.239 101 251 98.7614 251 96V89Z" stroke="#1B1A1A" stroke-width="2" />
              ...
              <path fill-rule="evenodd" clip-rule="evenodd" d="M502.923 49.6157H396.77V107.308H415.23V126.346L434.269 107.308H502.923V49.6157Z" fill="#EEEEEA" />
              ...
              <path fill-rule="evenodd" clip-rule="evenodd" d="M0.999817 491.538L231.769 491.538L231.769 413.077L213.308 413.077L213.308 394.615L194.847 413.077L0.999824 413.077L0.999817 491.538Z" fill="#EEEEEA" />
